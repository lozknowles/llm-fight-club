# Voice Lab delivery gates

- [x] Inspect actual installed OmniVoice and existing worker without changes.
- [x] Isolate feature from the live/canonical checkout.
- [x] Optional Voice Lab UI, consent, guided microphone capture and measurable quality feedback.
- [x] Provider-neutral conditioning interface and opt-in existing-worker extension (not activated).
- [x] Private persistence, hashing, rejection, deletion, extra takes and requalification.
